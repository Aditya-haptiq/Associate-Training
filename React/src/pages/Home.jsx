  ...
  <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
    <div className="space-y-6">
      ...
      <div className="space-x-4">
        ...
        <Link to="/about" className="btn-secondary-lg">
          Learn More
        </Link>
      </div>
    </div>
    <div className="flex justify-center md:justify-end">
      <img src="/src/assets/hero.jpg" alt="Fashionable styles" className="w-full max-w-md rounded-xl shadow-2xl" />
    </div>
  </div>
</section>
...
<section className="bg-white py-16">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <div className="flex flex-wrap justify-center items-center gap-8">
      <img src="src/assets/zara.jpg" alt="Zara" className="h-15 grayscale hover:grayscale-0 transition duration-300" />
      <img src="src/assets/levi.png" alt="Levi's" className="h-15 grayscale hover:grayscale-0 transition duration-300" />
      <img src="src/assets/pe.png" alt="Peter England" className="h-15 grayscale hover:grayscale-0 transition duration-300" />
      <img src="src/assets/hm.png" alt="H&M" className="h-15 grayscale hover:grayscale-0 transition duration-300" />
    </div>
  </div>
</section>
      ...
      {[
        {
          name: 'Aarav Mehta',
          role: 'Mumbai, India',
          image: '/src/assets/character1.jpg',
          feedback:
            'The fabric and fit are just amazing. Looks premium and feels great to wear.',
        },
        {
          name: 'Naina Sharma',
          role: 'Delhi, India',
          ...
          feedback:
            'Customer service was super responsive. Got my issue resolved in a day!',
        },
        {
          name: 'Kabir Gupta',
          role: 'Bangalore, India',
          image: '/src/assets/character3.jpg',
          feedback:
            'I’ve ordered 3 times already. Quality is consistent, and shipping is fast.',
        },
      ].map((t, i) => (
        <div
          key={i}
